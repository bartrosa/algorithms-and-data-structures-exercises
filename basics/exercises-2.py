#######################################################################################################################
# 1 We have a list of dictionaries representing product information (keys: "name", "price", "quantity").
# Write a function that generates a dictionary from this list, in which the key is the product name and the value is
# the total price of this product (price * quantity).
#

#######################################################################################################################
# 2 Create a list of dictionaries representing books (keys: "title", "author", "year"). Write a function that sorts
# this list of books alphabetically by title.
#

#######################################################################################################################
# 3 Create a function that takes a list of numbers and returns a set containing only the unique even numbers in the
# list.
#

#######################################################################################################################
# 4. Create a nested list where each item is a list of numbers. Write a function that returns a list of the sums
# of each nested list.
#
